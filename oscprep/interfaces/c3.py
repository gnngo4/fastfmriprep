...
class C3dAffineToolInputSpec(CommandLineInputSpec):
    reference_file = File(exists=True, mandatory=True, argstr='-ref %s', position=0, desc='reference image')
    ...
    ras2fsl = traits.Bool(mandatory=False, argstr='-ras2fsl', position=3, desc='ras2fsl flag')
